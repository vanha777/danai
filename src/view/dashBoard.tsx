...
import { sendAudioToTranscriptionAPI, ResponseData } from "../ultilities/ai";
...
const DashBoard = () => {
    ...
    if (isRecording) {
      ...
      navigator.mediaDevices.getUserMedia({ audio: true })
        .then((stream: MediaStream) => {
          ...
          //   console.log("this is text after transcribe , ",text);
          //   setTranscript(text);
          // };
  ...
  return (
    <div>
      <MobileMenu activeButton={activeButton} setActiveButton={setActiveButton} recording={handleRecording} />
      <div className="h-3/4 w-screen items-center justify-center pt-8 pb-8 pl-4 pr-6">
        <ThreeComponent chatBotState={botState} />
      </div>
      {/* {activeButton === 1 &&
